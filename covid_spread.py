...
teams = [slug, t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16,t17,t18,t19,t20,
...
assignRoom(theCorps, companies, rooms)
...
def closeContacts(infCadet, q, numInf):
  #need way to do class schedules
    contacts = set()
    infCompany = findCompany(infCadet)
    infRoom = findRoom(infCadet)
    infTeam = findTeam(infCadet)
...
#  print("Quarantine Length = {}".len(quarantine))    
...
#Testing Sentinel population
  for cadet in sentinelCadets:
    ...
    if testResults == "tP":
      ...
      ccInf = closeContacts(cadet, theCorps)
    elif testResults == "fP":
      numFP += 1
      quarantine.append([cadet,0])
      testPopulation.remove(cadet)
